...
import { addMinistriesFeed, removeMinistryFeed } from '../actions/ministriesFeed';

const UserMinistryListItem = ({ dispatch, id, minKey, ministryName, ministryGenre, createdAt }) => (
    <div className="list-item">
        ...
        <button onClick={() => {
            ...
            dispatch(addMinistriesFeed({ id, ministryName, ministryGenre }));
            //props.history.push('/');
        }}>Join</button>
        <button onClick={() => {
...
export default connect()(UserMinistryListItem);